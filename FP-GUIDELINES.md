...
check was introduced: **11 findings across 10 files
and 387 lines**. CI compares against that budget and fails only when a
...
|---|---:|---|---|---|
| `RS007` | 5 | warn | effects pushed outward | direct stdout/stderr effect in library code |
| `RS001` | 4 | warn | immutable values | mutable local binding (`let mut`) |
...
*effects pushed outward* · 5 occurrences at baseline

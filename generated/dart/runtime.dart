...
CliEnvValues loadFrom(String? Function(String key) lookup) {
  return CliEnvValues(
    apiBase: _nonEmpty(lookup('GHA_INDIE_WORKER_API_BASE')) ?? 'http://127.0.0.1:8080',
...
Map<String, String> loadEnvMap(
  ...
  final out = <String, String>{};
  final apiBase = pick(['GHA_INDIE_WORKER_API_BASE'], ['flags', 'env_shell', 'env_file'], shell, dotenv, flags, 'http://127.0.0.1:8080');
